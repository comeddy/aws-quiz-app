...
![Initialize Repository](https://d1wa5znsy892mi.cloudfront.net/images/git_initialize.png)
...
![커밋 메시지 입력](https://d1wa5znsy892mi.cloudfront.net/images/git_initialize_part2.png)

3. 변경 사항을 스테이지할지 묻는 프롬프트가 나타나면 "**Yes**"를 클릭합니다

![Stage Changes 확인](https://d1wa5znsy892mi.cloudfront.net/images/git_initialize_part3_stagechanges.png)
